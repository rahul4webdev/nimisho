...
class AppConstants {
  static const String appName = 'Nimisho Daily';
  static const double appVersion = 1; ///Flutter sdk 3.32.8

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://nimisho.com';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://app.nimisho.com';
  ...
  static const String placeSubscriptionOrderUri = '/api/v1/customer/order/subcription-place';
  static const String getweeklySub = '/api/v1/customer/order/order-subscription';
  ...
  static const String pauseSubscription = '/api/v1/subscription/pause';
  static const String subscriptionListUri = '/api/v1/subscription/list';
  static const String updateMySubscription = '/api/v1/subscription/update';
  ...
  static const String verifyPayment = '/payment/razor-pay/verify-payment';
  static const String createRazorPayOrder = '/payment/razor-pay/create-order';
  static const String addFundForSubscriptionUri = '/api/v1/customer/wallet/add-fund-subscription';
