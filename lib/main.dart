...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyDkImSD88auibdgqxnShe-qjbX8FcWCnHg",
        authDomain: "nimisho-daily.firebaseapp.com",
        projectId: "nimisho-daily",
        storageBucket: "nimisho-daily.firebasestorage.app",
        messagingSenderId: "408737008468",
        appId: "1:408737008468:web:b3e3d3230065b6e8d196c1"
    ));
  } else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyDkImSD88auibdgqxnShe-qjbX8FcWCnHg",
        appId: "1:408737008468:android:78ba17852123ce96d196c1",
        messagingSenderId: "408737008468",
        projectId: "nimisho-daily",
      ),
    );
