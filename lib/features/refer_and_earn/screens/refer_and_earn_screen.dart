                          ...
                          Wrap(children: [
                            ...
                            InkWell(
                              onTap: () {
                                ...
                                // );
                                Share.share(
                                  '🚀 Explore ${AppConstants.appName} – Your all-in-one app for Grocery Delivery, Food, and more! 🎉\n'
                                      '📥 Download: ${Get.find<SplashController>().configModel?.appUrlAndroid ?? 'https://app.Nimisho.com/appdownloads.html'}\n\n'
                                      'Referral Code: ${profileController.userInfoModel?.refCode ?? 'REFERRALCODE'}\n'
                                      '😍 Use my referral code to get exciting offers on your first order! 🎁',
                                );
                              },
                              child: Container(
