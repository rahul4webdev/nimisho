      ...
      child: Stack(children: [
        ...
        Positioned(
          ...
          child: Column(children: [
            ...
            Text('${packages.validity}' 'days'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: canSelect ? Theme.of(context).cardColor : Theme.of(context).disabledColor)),

            Divider(color: canSelect ? Theme.of(context).cardColor : Theme.of(context).disabledColor.withValues(alpha: 0.5), indent: 70, endIndent: 70, thickness: 1),
