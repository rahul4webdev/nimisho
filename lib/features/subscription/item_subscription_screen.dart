...
class ItemSubscriptionScreen extends StatefulWidget {
  final int itemId;
  final bool inStorePage;
  final bool? isCampaign;
  const ItemSubscriptionScreen({super.key, required this.itemId, required this.inStorePage, this.isCampaign});

  @override
  State<ItemSubscriptionScreen> createState() => _ItemSubscriptionScreenState();
}

class _ItemSubscriptionScreenState extends State<ItemSubscriptionScreen> {
