...
class OrderController extends GetxController implements GetxService {
  ...
  void paymentRedirect({required String url, required bool canRedirect, required String? contactNumber,
    ...
    required final String orderID, int? storeId, required bool createAccount, required String guestId,bool? isTypeSubscription = false}) {
    ...
    orderServiceInterface.paymentRedirect(
      ...
      createAccount: createAccount, guestId: guestId,isTypeSubscription: isTypeSubscription
    );
  }
}