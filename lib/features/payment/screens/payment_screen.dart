...
class PaymentScreen extends StatefulWidget {
  ...
  const PaymentScreen({super.key, required this.orderModel, required this.isCashOnDelivery, this.addFundUrl, required this.paymentMethod,
    required this.guestId, required this.contactNumber, this.storeId, this.subscriptionUrl, this.createAccount = false, this.createUserId, this.isTypeSubscription = false});
...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    ...
    if(widget.addFundUrl == '' && widget.addFundUrl!.isEmpty && widget.subscriptionUrl == '' && widget.subscriptionUrl!.isEmpty){
      selectedUrl = '${AppConstants.baseUrl}/payment-mobile?customer_id=${widget.createAccount ? widget.createUserId : widget.orderModel.userId == 0 ? widget.guestId : widget.orderModel.userId}&order_id=${widget.orderModel.id}&payment_method=${widget.paymentMethod}&is_type_subscription=${widget.isTypeSubscription}';
  ...
  void _initData() async {
    ...
    browser = MyInAppBrowser(
      ...
      guestId: widget.guestId,isTypeSubscription: widget.isTypeSubscription
    );
...
class MyInAppBrowser extends InAppBrowser {
  ...
  MyInAppBrowser({
    ...
    required this.createAccount, required this.guestId,this.isTypeSubscription = false});
  ...
  Future onLoadStart(url) async {
    ...
    Get.find<OrderController>().paymentRedirect(
      ...
      subscriptionUrl: subscriptionUrl, createAccount: createAccount, guestId: guestId,isTypeSubscription: isTypeSubscription
    );
