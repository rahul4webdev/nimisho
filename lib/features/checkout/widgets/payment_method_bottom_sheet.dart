...
class PaymentMethodBottomSheet extends StatefulWidget {
  ...
  const PaymentMethodBottomSheet({super.key, required this.isCashOnDeliveryActive, required this.isDigitalPaymentActive,
    required this.isWalletActive,this.shudule, required this.storeId, required this.totalPrice, required this.isOfflinePaymentActive});
      ...
      child: GetBuilder<CheckoutController>(builder: (checkoutController) {
        ...
        return Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(widget.shudule == true ? 'Select Method To Recharge Wallet' : 'choose_payment_method'.tr,
                style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
            // Text(widget.shudule.toString(),
            //     style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
            // const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(widget.shudule == true ? 'Per Order Price' : 'total_bill'.tr, style: robotoMedium.copyWith(fontSize: 14, color: Colors.grey.shade700)),
                    ),
