...
class PaymentSection extends StatelessWidget {
  ...
  const PaymentSection({super.key, this.storeId,this.shudule, required this.isCashOnDeliveryActive, required this.isDigitalPaymentActive,
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        if (shudule == true) ...[
          Text(
            'Select Payment Option for Wallet Recharge',
            style: robotoMedium,
          ),
        ] else ...[
          Text(
          ...
          onTap: (){
            Get.bottomSheet(
              PaymentMethodBottomSheet(
                ...
                isWalletActive: isWalletActive, storeId: storeId, shudule: shudule, totalPrice: total, isOfflinePaymentActive: isOfflinePaymentActive,
              ),
