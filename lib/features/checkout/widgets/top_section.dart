...
class TopSection extends StatelessWidget {
  ...
  const TopSection({
    ...
    required this.badWeatherCharge, required this.extraChargeForToolTip, this.promo = true,this.shudule = false,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        /// Coupon..
        !isDesktop && !isGuestLoggedIn && promo! ? CouponSection(
        ...
        Container(
          ...
          child: Column(children: [
            ...
            PaymentSection(
              storeId: storeId, shudule: shudule, isCashOnDeliveryActive: isCashOnDeliveryActive, isDigitalPaymentActive: isDigitalPaymentActive,
