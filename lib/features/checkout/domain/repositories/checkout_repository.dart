...
class CheckoutRepository implements CheckoutRepositoryInterface {
  ...
  @override
  Future<Response> placeSubscriptionOrder(PlaceOrderBodyModel orderBody, List<MultipartBody>? orderAttachment) async {
    print('farukh--------');
    print(orderBody.toJson());
    print('farukh--------');
    return await apiClient.postMultipartData(AppConstants.placeSubscriptionOrderUri, orderBody.toJson(), orderAttachment ?? [], handleError: false);
  }
  @override
  Future<Response> getweeklySub() async {
    return await apiClient.getData('${AppConstants.getweeklySub}');
  }
  ...
  @override
  Future<Response> getOrderPaymentId(String url) async {
  ...
  Future<Response> getPaymentVerify(String payment_id, String razorpay_id,String order_id,String signature) async {
    ...
    return await apiClient.getData('${AppConstants.verifyPayment}?payment_request_id=$payment_id&payment_id=$razorpay_id&order_id=$order_id&signature=$signature');
  }
  @override
  Future<Response> createRazorpayOrder(double amount) async {
    return await apiClient.getData('${AppConstants.createRazorPayOrder}?payment_amount=$amount&currency_code=INR');
  }
