...
class PlaceOrderBodyModel {
  ...
  PlaceOrderBodyModel({
    ...
    isSubscriptionOrder = isSubscriptionOrder ?? false;
    subscriptionData = subscriptionData;
  ...
  bool? get isSubscription => isSubscriptionOrder;
  SubscriptionData? get subscriptionDatas => subscriptionData;
  String? get subscriptionTypes => subscriptionType;
  ...
  PlaceOrderBodyModel.fromJson(Map<String, dynamic> json) {
    ...
    isSubscriptionOrder = json['is_subscription'] != null ? json['is_subscription'] == 'true' : false;
  ...
  Map<String, String> toJson() {
    ...
    data['is_subscription'] = isSubscriptionOrder == true ? 'true' : 'false';
    if(subscriptionData !=null){
      data['subscription_data'] =  jsonEncode(subscriptionData!.toJson());
    }
