...
class CheckoutService implements CheckoutServiceInterface {
  ...
  Future<Response> placeSubscriptionOrder(PlaceOrderBodyModel orderBody, List<MultipartBody> orderAttachment) async {
    return await checkoutRepositoryInterface.placeSubscriptionOrder(orderBody, orderAttachment);
  }


  @override
  Future<Response> getOrderPaymentId(String url) async {
    return await checkoutRepositoryInterface.getOrderPaymentId(url);
  }
  @override
  Future<Response> getweeklySub() async {
    return await checkoutRepositoryInterface.getweeklySub();
  }

  @override
  Future<Response> createRazorpayOrder(double amount) async {
    return await checkoutRepositoryInterface.createRazorpayOrder(amount);
  }

  @override
  Future<Response> getPaymentVerify(String payment_id, String razorpay_id,String order_id,String signature) async {
    return await checkoutRepositoryInterface.getPaymentVerify(payment_id, razorpay_id,order_id,signature);
  }
