...
abstract class CheckoutServiceInterface {
  ...
  Future<Response> getOrderPaymentId(String url);
  ...
  Future<Response> getweeklySub();

  Future<Response> placeSubscriptionOrder(PlaceOrderBodyModel orderBody, List<MultipartBody> orderAttachment);
