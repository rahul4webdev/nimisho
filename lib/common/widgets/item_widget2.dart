...
class ItemWidget2 extends StatelessWidget {
  ...
  const ItemWidget2({super.key, required this.item, required this.isStore, required this.store, required this.index,
                    ...
                    Expanded(
                        child: Column(children: [
                          ...
                          (Get.find<SplashController>()
                              ...
                              ? const SizedBox()
                              : Row(
                            mainAxisAlignment: MainAxisAlignment.end, // 👈 Pushes to right
                            children: [
                              Padding(
