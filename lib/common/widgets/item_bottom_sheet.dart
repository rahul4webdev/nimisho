...
class ItemBottomSheet extends StatefulWidget {
  ...
  const ItemBottomSheet({super.key, required this.itemId, this.isCampaign = false, this.cart, this.cartIndex, this.inStorePage = false});
...
class _ItemBottomSheetState extends State<ItemBottomSheet> {
  ...
  void initState() {
    ...
    itemController.getItemDetails(itemId: widget.itemId, cart: widget.cart).then((_) {
