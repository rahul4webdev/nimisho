...
class ConfigModel {
  ...
  String? email;
  String? country;
  String? min_subscription_amount;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    min_subscription_amount = json['min_subscription_amount'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['min_subscription_amount'] = min_subscription_amount;
